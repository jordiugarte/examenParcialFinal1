...
public class MyStepdefs {
    ...
    public void iHaveAccessToTodoLy() {
        System.out.println("Access to todo.ly");
    }
    ...
    @And("I wait for the response code to be {int}")
    ...
    public void iWaitForTheResponseBodyToBe(String expectedBody) {
    ...
    @And("I have the {} and I save it in {}")
    public void iHaveTheValueAndISaveItIn(String property, String nameVar) {
        data.put(nameVar, response.then().extract().path(property) + "");
    }

    @When("I send an UPDATE request to {} with json")
    public void yoEnvioUnaPeticionPUTAlUrlHttpTodoLyApiProjectsID_PROJECTJsonConJson(String url, String body) {
        response = given().
                auth().
                preemptive().
                basic("newuser@newuser.com", "12345678").
                contentType(ContentType.JSON).
                body(body).
                log().
                all().
    ...
    public void iSendAPutRequestTo(String url, String body) {
        response = given().
                auth().
                preemptive().
    ...
    @When("I send a GET request to {} with json")
    public void iSendAGetRequest(String url, String body) {
        response = given().
                auth().
                preemptive().
                basic("jordi@ugarte.com", "123456789").
    ...
    @When("I send a DELETE request to {} with json")
    public void iSendADeleteRequestTo(String url, String body) {
        response = given().
                auth().
                preemptive().
                basic("jordi@ugarte.com", "123456789").
